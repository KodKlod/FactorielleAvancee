...
public class FactorielleTest {
	...
	@Test
	public void factorielle_de_1_doit_renvoyer_1() throws ExceptionFactorielle{
		// GIVEN
		long entier = 1;
	...
	@Test
	public void factorielle_de_2_doit_renvoyer_2()throws ExceptionFactorielle {
	...
	@Test
	public void factorielle_de_3_doit_renvoyer_6()throws ExceptionFactorielle {
	...
	@Test
	public void factorielle_de_18_doit_renvoyer_6402373705728000()throws ExceptionFactorielle {
		assertEquals(6402373705728000l, factorielle.calculer(18));
	}

	@Test
	public void factorielle_de_0_doit_renvoyer_1()throws ExceptionFactorielle {
	...
	public void factorielle_d_un_nombre_negatif_doit_declencher_une_exception() throws ExceptionFactorielle {
		factorielle.calculer(-1);
	}
	
	@Test(timeout=1) 
	public void factorielle_18_repete_100_fois_doit_sexecuter_en_moints_de_10_ms() throws ExceptionFactorielle{
		for (int i = 1 ; i<= 100 ; i++)
			factorielle.calculer(18);
	}
	
	@Test
	public void factorielle_de_18_doit_renvoyer_6402373705728000_avec_hamcrest() throws ExceptionFactorielle {
		// GIVEN
		long entier = 18;
	...
	//Factorielle de 50 ne peut etre calculé
	@Test(expected = ExceptionFactorielle.class)
	public void factoriellede50NEstPasCalculable()throws ExceptionFactorielle {
